...
const Technology = () => {
    ...
    const [techSectionHeight, setTechSectionHeight] = useState(50)
    ...
    useEffect(() => {
        if (window.screen.width < 600) {
            setTechSectionHeight(110)
        } else {
            setTechSectionHeight(50)
        }
    }, [])


    return (
        <div ref={techSection} className='section-technology' style={{ height: `${techSectionHeight * TechnicalSkills.length}vw` }}>
            <div className='technology-container'>
                ...
                <div ref={horizontalScroll} className='tech-boxes-container'>
                    {
                        TechnicalSkills.map(({ skillName, skillLevel, skillIcon, skillColor, skillDesc, extra, skillImage }, index) => {
                            return (
                                <div className='tech-boxes' key={index}>
                                    <div className='box' style={{ backgroundColor: 'white' }}>
                                        <div className='box-container' >
                                            <div className='box-first'>
                                                <div className='box-first-left'>

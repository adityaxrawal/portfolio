...
const HeroSection = () => {
  ...
  const calculateImageSize = useCallback(() => {
    let newWidth = window.innerWidth * 0.2; // Image takes 30% of screen width
        ...
        >
          ...
          <span className="headline-text">
            ...
            <span className="headline-sub-text">
              ...
              developer.
              <br />
              <RoughNotation type="circle" order="7" color="orange">
                {" "}
                Hire me?
              </RoughNotation>
            </span>
      ...
      >
        ...
        >
          ...
          <div className="image-card-part-two">
            <span style={{ color: isDarkTheme ? "black" : "black" }}>
              Aditya Rawal
            </span>

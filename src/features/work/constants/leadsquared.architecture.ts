  ...
  rows: [
    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          icon: 'Shield',
          iconColor: '#ef4444' /* TODO: palette - tech brand color */,
        },
        {
          id: 'api-gw',
          label: 'API Gateway',
          subLabel: '(Request Routing)',
          icon: 'Network',
    ...
    },
    {
      ...
      nodes: [
        ...
        {
          id: 'webhooks',
          label: 'Webhook Processors',
          icon: 'RefreshCw',
          iconColor: '#06b6d4' /* TODO: palette - tech brand color */,
        },
        {
          id: 'auth',
          label: 'Auth Service',
      ...
      nodes: [
        {
          ...
          subLabel: '(Primary)',
          icon: 'Database',
          iconColor: '#4f46e5' /* TODO: palette - tech brand color */,
        },
        {
          id: 'rds',
          label: 'RDS',

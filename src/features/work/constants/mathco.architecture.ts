      ...
      nodes: [
        {
          id: 'postgres',
          label: 'PostgreSQL',
          subLabel: '(Operational DB)',
          icon: 'SiPostgresql',
          iconColor: '#336791' /* TODO: palette - tech brand color */,
        },
        {
          id: 'redis',
          label: 'Redis',
        ...
        },
        {
          ...
          subLabel: '(Data Lake)',
          icon: 'Archive',
          iconColor: '#3CB054' /* TODO: palette - tech brand color */,
        },
      ],
      ...
      nodes: [
        {
          ...
          iconColor: '#017CEE' /* TODO: palette - tech brand color */,
        },
        {
          id: 'glue',
          label: 'AWS Glue',
          subLabel: '(Data Preparation)',
          icon: 'Filter',
          iconColor: '#8B5CF6' /* TODO: palette - tech brand color */,
        },
      ],
    ...
    },
    {
      ...
      nodes: [
        ...
        },
        {
          ...
          subLabel: '(Market, External)',
          icon: 'Globe',
          iconColor: '#0ea5e9' /* TODO: palette - tech brand color */,
        },
        {
          id: 'manual',
          label: 'Manual Uploads',
          subLabel: '(Spreadsheets)',
          icon: 'Upload',
          iconColor: '#64748b' /* TODO: palette - tech brand color */,
        },
      ],
